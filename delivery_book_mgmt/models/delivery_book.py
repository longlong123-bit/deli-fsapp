...
from odoo.addons.stock_extend.wizard.booking_viettelpost_wizard import BookingViettelpostWizard
from odoo.addons.stock_extend.wizard.booking_ahamove_wizard import BookingAhamoveWizard
